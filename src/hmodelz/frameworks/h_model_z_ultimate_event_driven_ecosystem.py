...
events.register(
    "hhat_compute",
    lambda t, base, stoch: logging.info(
        f"H_hat computed at t={t}, base={base:.4f}, stoch={stoch:.4f}"
    ),
)
...
def mastery_param_level():
    return f"rho={params['rho']:.2f}, lambda={params['lambda']:.3f}"
