...
logging.basicConfig(
    ...
    handlers=[logging.FileHandler("organization.log"), logging.StreamHandler()],
)
...
class ProjectOrganizer:
    ...
    def _create_organization_plan(self) -> Dict[str, Dict]:
        ...
        return {
            ...
            "src/": {
                ...
                "patterns": ["h_model_z_*.py", "*_framework.py", "*_engine.py", "schema_*.py"],
            },
            # CONFIGURATION
            "config/": {
                ...
                "patterns": ["*.json", "*.toml", "*.yaml", "*.yml", "env.*", "*config*"],
            },
            # DOCUMENTATION
            "docs/": {
                ...
                "patterns": ["*.md", "*.tex", "*.html", "*README*", "*GUIDE*", "*REPORT*"],
            },
            # TESTING
            "tests/": {
            ...
            "benchmarks/": {
                ...
                "patterns": ["*benchmark*.py", "*performance*.py", "hamiltonian_*.py"],
            },
            # EXAMPLES AND DEMOS
            "examples/": {
                ...
                "patterns": ["demo_*.py", "example_*.py", "*_demo.py", "interactive_*.py"],
            },
            # SCRIPTS AND TOOLS
            "scripts/": {
                ...
                "patterns": ["*.ps1", "*.sh", "setup*", "install*", "deploy*", "*_analysis.py"],
            },
            ...
            "blockchain/": {
                ...
                "patterns": ["*.sol", "*.js", "*.rs", "hardhat*", "foundry*", "Cargo.toml"],
            },
            # DATA AND ASSETS
            "assets/": {
                ...
                "patterns": ["*.png", "*.jpg", "*.svg", "*.html", "*.json", "*.csv"],
            },
            ...
            "build/": {
                ...
                "patterns": ["Dockerfile*", "docker-compose*", "*.dockerfile", "Makefile"],
            },
        }
    ...
    def create_backup(self):
        ...
        essential_patterns = ["*.py", "*.js", "*.rs", "*.json", "*.md", "*.toml", "*.yaml"]
                        ...
                        if file_path.match(pattern):
                            ...
                            if not target_path.exists():
                                ...
                                organization_log.append(
                                    f"Moved {file_path.name} -> {target_path.relative_to(self.root)}"
                                )
                                moved = True
                                break
            ...
            for dir_name in dirs:
                ...
                try:
                    if not any(dir_path.iterdir()):
                        ...
                        if not any(
                            dir_path.match(pattern) for pattern in self.organization_plan.keys()
                        ):
                            dir_path.rmdir()
