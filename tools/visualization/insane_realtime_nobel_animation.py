...
class InsaneNobelAnimation:
    def __init__(self):
        ...
        self.fig.suptitle(
            "🔥 INSANE NOBEL PRIZE H_MODEL_Z ANIMATION 🔥\n"
    ...
    def animate_test_rocket(self, ax):
        ...
        # Draw rocket
        ax.scatter(
            rocket_x, rocket_height, s=200, c="lime", marker="^", edgecolor="white", linewidth=2
        )
    ...
    def animate_lightning_progression(self, ax):
        ...
        ax.set_ylim(80, 105)
        ax.set_title(
            "⚡ LIGHTNING PROGRESSION TO LEGENDARY", fontsize=12, fontweight="bold", color="yellow"
        )
        ...
        if len(x_data) > 1:
            ...
            ax.plot(x_data, y_data, "o-", linewidth=4, markersize=10, color="yellow", alpha=0.9)
        ...
        for i in range(8):
            ...
            ax.text(
                ...
                bbox=dict(
                    ...
                    facecolor=random.choice(["red", "blue", "green"]),
                    alpha=0.7,
                ),
            )
    ...
    def animate_trophy_rain(self, ax):
        ...
        for _ in range(20):
            ...
            if 0 <= y <= 10:
                ax.scatter(
                    x, y, s=size, c="gold", marker="*", alpha=0.8, edgecolor="orange", linewidth=1
                )
        ...
        for _ in range(10):
            ...
            for j in range(8):
                ...
                ax.plot(
                    [x, spark_x], [y, spark_y], color=random.choice(colors), linewidth=3, alpha=0.7
                )
    ...
    def animate_frame(self, frame_num):
        ...
        self.fig.suptitle(
            f"🔥 INSANE NOBEL PRIZE H_MODEL_Z ANIMATION 🔥\n"
